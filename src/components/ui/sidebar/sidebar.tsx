...
export function Sidebar({ toggleSidebar, expanded }: SidebarProps) {
  return (
    ...
    >
      <div
        className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-[#222]"
      ...
      >
        ...
        <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
          ...
          <li>
            <a
              href="#"
              className="flex  mt-72 flex-1 items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group"
            >
              <BiExit />
